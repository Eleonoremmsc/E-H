...
const T = {
  en: {
    ...
    filter_all:          'All',
    filter_hotel:        'Hotels',
    filter_rooms:        'Book a room',
    filter_whole:        'Whole place',
    ...
    tier_hotel:          'Hotel room',
    tier_guest_room:     'B&B room',
    tier_whole_home:     'Whole house',
    tier_gite:           'Gîte',
    accom_guests:        'guests',
    accom_up_to:         'up to',
    accom_rooms:         'rooms',
    ...
    note_becaras:        'The whole house sleeps ten, and the owners also let individual B&B rooms with breakfast — so it works either way. Pool, garden and Ventoux views.',
    ...
    note_mas_stgens:     'A 17th-century mas outside Carpentras: three houses and three apartments, 17 bedrooms in all. The largest option on this list.',
    note_maison_divine:  'A bastide in the village of Villes-sur-Auzon, at the foot of the Ventoux. Eight bedrooms, a mosaic pool and a Mediterranean garden.',
    note_moulin:         'Several gîtes on one estate, so a big group can stay together — and a few B&B rooms if you would rather book just one.',
    ...
    note_mas_stjacques:  'The closest option to the venue: a five-room guest house among the vineyards, with a pool. You book one room, not the house.',
    note_jas_ventoux:    'A one-bedroom gîte with a private hot tub and a view of the Ventoux, minutes from the venue.',
    note_brin_bois:      'A tiny eco-built gîte for two, with its own terrace and use of the pool. The most affordable place on this list.',
    note_sidoine:        'Four separate little gîtes in a two-hectare park with a pool and hot tub. Each is rented on its own, so a few couples can take one each.',
    note_clos_marceau:   'A well-rated five-room B&B in the centre of Bédoin, breakfast included. You book a single room.',
    ...
    accom_stay_help:     'Two words worth knowing. A gîte is a self-catering holiday house rented as a whole — kitchen, bedrooms and all — which suits a family or a few couples booking together. A chambre d’hôtes is a bed & breakfast where you book a single room, breakfast included. Each card below says which it is: “Book a room” means exactly that — you never have to take a whole house.',
  ...
  fr: {
    ...
    filter_all:          'Tous',
    filter_hotel:        'Hôtels',
    filter_rooms:        'À la chambre',
    filter_whole:        'Logement entier',
    filter_luxury:       'Luxe',
    ...
    tier_hotel:          'Hôtel',
    tier_guest_room:     "Chambre d'hôtes",
    tier_whole_home:     'Maison entière',
    tier_gite:           'Gîte',
    accom_guests:        'personnes',
    accom_up_to:         "jusqu'à",
    accom_rooms:         'chambres',
    ...
    note_becaras:        "La maison entière accueille dix personnes, et les propriétaires louent aussi des chambres d'hôtes avec petit-déjeuner — les deux formules sont possibles. Piscine, jardin et vue sur le Ventoux.",
    ...
    note_mas_stgens:     "Un mas du XVIIe siècle aux portes de Carpentras : trois maisons et trois appartements, 17 chambres en tout. La plus grande capacité de cette liste.",
    note_maison_divine:  "Une bastide au cœur du village de Villes-sur-Auzon, au pied du Ventoux. Huit chambres, une piscine en mosaïque et un jardin méditerranéen.",
    note_moulin:         "Plusieurs gîtes sur un même domaine : un grand groupe peut y rester ensemble. Quelques chambres d'hôtes aussi, si vous préférez n'en réserver qu'une.",
    ...
    note_mas_stjacques:  "L'option la plus proche du lieu de réception : une maison d'hôtes de cinq chambres au milieu des vignes, avec piscine. On réserve une chambre, pas la maison.",
    note_jas_ventoux:    "Un gîte d'une chambre avec spa privatif et vue sur le Ventoux, à quelques minutes du lieu de réception.",
    note_brin_bois:      "Un tout petit gîte écologique pour deux, avec sa terrasse et l'accès à la piscine. L'option la plus économique de cette liste.",
    note_sidoine:        "Quatre petits gîtes indépendants dans un parc de deux hectares avec piscine et jacuzzi. Chacun se loue séparément : plusieurs couples peuvent en prendre un chacun.",
    note_clos_marceau:   "Une chambre d'hôtes de cinq chambres bien notée, au centre de Bédoin, petit-déjeuner compris. On réserve une seule chambre.",
    ...
    accom_stay_help:     "Deux mots utiles. Un gîte est une maison de vacances louée en entier — cuisine, chambres, tout — ce qui convient à une famille ou à quelques couples qui réservent ensemble. Une chambre d'hôtes se réserve à la chambre, petit-déjeuner compris. Chaque fiche ci-dessous le précise : « À la chambre » veut dire exactement cela — vous n'avez jamais à prendre une maison entière.",
  ...
  de: {
    ...
    filter_all:          'Alle',
    filter_hotel:        'Hotels',
    filter_rooms:        'Einzelzimmer',
    filter_whole:        'Ganze Unterkunft',
    filter_luxury:       'Luxus',
    ...
    tier_hotel:          'Hotelzimmer',
    tier_guest_room:     'Gästezimmer',
    tier_whole_home:     'Ganzes Haus',
    tier_gite:           'Gîte',
    ...
    note_becaras:        'Das ganze Haus bietet Platz für zehn Personen, und die Gastgeber vermieten auch einzelne Gästezimmer mit Frühstück — beides ist möglich. Pool, Garten und Blick auf den Ventoux.',
    ...
    note_mas_stgens:     'Ein Mas aus dem 17. Jahrhundert vor den Toren von Carpentras: drei Häuser und drei Wohnungen, insgesamt 17 Schlafzimmer. Die größte Unterkunft dieser Liste.',
    note_maison_divine:  'Eine Bastide im Dorf Villes-sur-Auzon, am Fuße des Ventoux. Acht Schlafzimmer, ein Mosaikpool und ein mediterraner Garten.',
    note_moulin:         'Mehrere Gîtes auf einem Anwesen, sodass eine große Gruppe zusammen bleiben kann — und einige Gästezimmer, falls Sie lieber nur eines buchen.',
    ...
    note_mas_stjacques:  'Die nächstgelegene Option zur Feier: ein Gästehaus mit fünf Zimmern inmitten der Weinberge, mit Pool. Sie buchen ein Zimmer, nicht das Haus.',
    note_jas_ventoux:    'Ein Gîte mit einem Schlafzimmer, privatem Whirlpool und Blick auf den Ventoux, wenige Minuten von der Feier entfernt.',
    note_brin_bois:      'Ein winziger, ökologisch gebauter Gîte für zwei, mit eigener Terrasse und Poolnutzung. Die günstigste Unterkunft dieser Liste.',
    note_sidoine:        'Vier separate kleine Gîtes in einem zwei Hektar großen Park mit Pool und Whirlpool. Jeder wird einzeln vermietet, sodass mehrere Paare je einen nehmen können.',
    note_clos_marceau:   'Ein gut bewertetes Gästehaus mit fünf Zimmern im Zentrum von Bédoin, Frühstück inklusive. Sie buchen ein einzelnes Zimmer.',
    ...
    accom_stay_help:     'Zwei nützliche Begriffe. Ein Gîte ist ein Ferienhaus, das komplett gemietet wird — mit Küche und Schlafzimmern — ideal für eine Familie oder ein paar Paare, die zusammen buchen. Eine Chambre d’hôtes ist eine Pension, in der Sie ein einzelnes Zimmer buchen, Frühstück inklusive. Jede Karte unten sagt, was es ist: „Einzelzimmer“ heißt genau das — Sie müssen nie ein ganzes Haus nehmen.',
