...
const T = {
  en: {
    ...
    dress_sat_intro:     'We invite our guests to dress elegantly for a Provençal summer evening.',
  ...
  fr: {
    ...
    dress_sat_headline:  'Tenue formelle',
    dress_sat_intro:     "Nous invitons nos invités à s'habiller avec élégance pour une soirée d'été provençale.",
  ...
  de: {
    ...
    dress_sat_headline:  'Formelle Kleidung',
    dress_sat_intro:     'Wir laden unsere Gäste ein, sich elegant für einen provenzalischen Sommerabend zu kleiden.',
